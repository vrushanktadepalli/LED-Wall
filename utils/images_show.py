...
default_image_folder = os.path.join(os.path.dirname(__file__), "..", "assets", "images")

def increase_brightness(img, gamma=20.0):
...
def cycle_images(folder=default_image_folder, delay_time=2):
...
def main():
    ...
    try:
        cycle_images(default_image_folder)
